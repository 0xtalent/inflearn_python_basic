...
print("Capitalize: ", str_o1.capitalize()) # 첫글자 대문자로 만들으라
print("endswith?: ", str_o2.endswith("s")) # 마지막 문제가 뭐이니?
print("join str: ", str_o1.join(["I'm ", "!"]))
print("replace1: ", str_o1.replace('thon', ' Good'))
print("replace2: ", str_o3.replace("are", "was"))
print("split: ", str_o4.split(' '))  # 특정 단위로 분리하라
